...
**Menu bar icon** — click to open the menu:
...
**Overlay** — when the battery hits your threshold while unplugged, an overlay appears in the center of your screen. It stays there until you plug in. No dismiss button.
